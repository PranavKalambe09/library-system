    ...
    <div class="flex-grow">
        <div
            ...
            <table class="table-auto text-white my-4 border-collapse backdrop-blur-sm bg-white/30 rounded-xl px-5 ">
                <thead>
                    <th scope="col" class="mx-4 px-14 py-3 border-b-2 border-slate-300 border-r-2">Student ID</th>
                    <th scope="col" class="mx-4 px-14 py-3 border-b-2 border-slate-300 border-r-2">Name</th>
                    <th scope="col" class="mx-4 px-14 py-3 border-b-2 border-slate-300 border-r-2">Book Name</th>
                    <th scope="col" class="mx-4 px-14 py-3 border-b-2 border-slate-300 ">Book Author</th>
                </thead>
                <tbody>
                    <?php
                    include 'src/_config.php';
                    ...
                    while ($row = mysqli_fetch_assoc($result)) {
                        echo '<tr class="">
                        <td class="px-4 py-4">' . $row["sid"] . '</td>
                        <td class="px-4 py-4">' . $row["s_name"] . '</td>
                        <td class="px-4 py-4">' . $row["b_name"] . '</td>
                        <td class="px-4 py-4">' . $row["b_author"] . '</td></tr>';
                    }
