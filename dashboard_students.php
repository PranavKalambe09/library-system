        ...
        <div
            ...
            <table class="table-auto text-white my-4 border-collapse backdrop-blur-sm bg-white/30 rounded-xl px-5 ">
                <thead>
                    ...
                    <th scope="col" class="mx-4 px-14 py-3 border-b-2 border-slate-300 border-r-2">Faculty</th>
                    <th scope="col" class="mx-4 px-14 py-3 border-b-2 border-slate-300 ">Phone Number</th>
                </thead>
                <tbody>
                    <?php
                    include 'src/_config.php';
                    ...
                    while ($row = mysqli_fetch_assoc($result)) {
                        ...
                        <td class="px-4 py-1">' . $row["s_name"] . '</td>
                        <td class="px-4 py-1">' . $row["faculty"] . '</td>
                        <td class="px-4 py-1">' . $row["phone_number"] . '</td></tr>';
                    }
